                                ...
                                <div class="mask d-flex align-items-center h-100 gradient-custom-3">
                                    ...
                                    <!-- form to add user -->
                                                    ...
                                                    <div class="form-outline mb-2">
                                                        ...
                                                        <input type="text" id="name" name="name" class="form-control form-control-lg" value="<?= $team->name; ?>">
                                                    </div>

                                                    <div class="form-outline mb-2">
                                                        <label class="form-label" for="form3Example1cg">coach</label>
                                                        <input type="text" id="coach" name="coach" class="form-control form-control-lg" value="<?= $team->coach ?>">
                                                    </div>

                                                    <div class="form-outline mb-2">
                                                        <label class="form-label" for="form3Example1cg">description</label>
                                                        <input type="text" id="description" name="description" class="form-control form-control-lg" value="<?= $team->description; ?>">
                                                    </div>

                                                    <div class="form-outline mb-2">
                                                        <label class="form-label" for="form3Example1cg">groupe</label>
                                                        <input type="text" id="groupe" name="groupe" class="form-control form-control-lg" value="<?= $team->groupe; ?>">
                                                    </div>

                                                    <div class="form-outline mb-2">
                                                        <label class="form-label" for="form3Example1cg">cups</label>
                                                        <input type="text" id="cups" name="cups" class="form-control form-control-lg" value="<?= $team->cups; ?>">
                                                    </div>
