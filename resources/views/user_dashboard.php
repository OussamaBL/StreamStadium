...
<head>
    ...
    <!-- Fontfaces CSS-->
    <link href="../public/css/css/font-face.css" rel="stylesheet" media="all">
    <link href="../public/css/vendor/font-awesome-4.7/css/font-awesome.min.css" rel="stylesheet" media="all">
    <link href="../public/css/vendor/font-awesome-5/css/fontawesome-all.min.css" rel="stylesheet" media="all">
    <link href="../public/css/vendor/mdi-font/css/material-design-iconic-font.min.css" rel="stylesheet" media="all">

    <!-- Bootstrap CSS-->
    <link href="../public/css/vendor/bootstrap-4.1/bootstrap.min.css" rel="stylesheet" media="all">
    <link rel="stylesheet" href="../public/css/bootstrap.min.css">


    <!-- Vendor CSS-->
    <link href="../public/css/vendor/animsition/animsition.min.css" rel="stylesheet" media="all">
    <link href="../public/css/vendor/bootstrap-progressbar/bootstrap-progressbar-3.3.4.min.css" rel="stylesheet" media="all">
    <link href="../public/css/vendor/wow/animate.css" rel="stylesheet" media="all">
    <link href="../public/css/vendor/css-hamburgers/hamburgers.min.css" rel="stylesheet" media="all">
    <link href="../public/css/vendor/slick/slick.css" rel="stylesheet" media="all">
    <link href="../public/css/vendor/select2/select2.min.css" rel="stylesheet" media="all">
    <link href="../public/css/vendor/perfect-scrollbar/perfect-scrollbar.css" rel="stylesheet" media="all">
    <link href="../public/css/vendor/vector-map/jqvmap.min.css" rel="stylesheet" media="all">
    ...
    <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="/streamstadium/user/add" method="POST">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php foreach ($result as $users):?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <!-- button to add -->
                                                                <a href="/streamstadium/user/destroy/<?= $users->id ?>" onclick="return confirm('Do you want to Delete these team ?');" class="btn btn-outline-danger btn-sm">Supprimer</a>
                                                            </td>
                                                        </tr>
                                                    <?php endforeach; ?>
                                                    <?php endif; ?>
...
<section>
    ...
    <script src="../public/vendor/vector-map/jquery.vmap.js"></script>
    <script src="../public/vendor/vector-map/jquery.vmap.min.js"></script>
    <script src="../public/vendor/vector-map/jquery.vmap.sampledata.js"></script>
    <script src="../public/vendor/vector-map/jquery.vmap.world.js"></script>
